...
m1_gee_disc_reversed <- 
  geem(data=sns_dt_long_merged_ego_characteristics, cdc_avg_out_adequate ~ 
                 SN27_reversed, id = MTURKID, family="binomial")
...
m2_gee_disc_reversed <- 
  geem(data=sns_dt_long_merged_ego_characteristics, cdc_avg_out_adequate ~ 
                 SN28_reversed, id = MTURKID, family="binomial")
...
m2a_gee_disc_reversed <- 
  geem(data=sns_dt_long_merged_ego_characteristics, cdc_avg_out_adequate ~ 
                 SN29_reversed, id = MTURKID, family="binomial")
...
m3_gee_disc_reversed <- 
  geem(data=sns_dt_long_merged_ego_characteristics, cdc_avg_out_adequate ~ 
                 SN33_reversed, id = MTURKID, family="binomial")
...
m4_gee_disc_reversed <- 
  geem(data=sns_dt_long_merged_ego_characteristics, cdc_avg_out_adequate ~ 
                 SN34_reversed, id = MTURKID, family="binomial")
...
m5_gee_disc_reversed <- 
  geem(data=sns_dt_long_merged_ego_characteristics, cdc_avg_out_adequate ~ 
                 SN37_reversed, id = MTURKID, family="binomial")
...
m6_gee_disc_reversed <- 
  geem(data=sns_dt_long_merged_ego_characteristics, cdc_avg_out_adequate ~ 
                 SN38_reversed, id = MTURKID, family="binomial")
...
m7_gee_disc_reversed <- 
  geem(data=sns_dt_long_merged_ego_characteristics, cdc_avg_out_adequate ~ 
                 SN39_reversed, id = MTURKID, family="binomial")
...
model_vh1 <- geem(data=sns_dt_long_merged_ego_characteristics, vh1_adequate ~ 
                 SN27 + SN28 + SN29 + SN33 + SN34 + SN37 + SN38, id = MTURKID, 
                 family="binomial")
summary(model_cdc1)
```
